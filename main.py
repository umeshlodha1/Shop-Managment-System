...
class Bill_App:
    def __init__(self, master):
        ...
        title = Label(self.master, text="SUPERMARKET MANAGEMENT", bd=12, relief=GROOVE, bg="light grey",
        ...
        F0 = LabelFrame(self.master, bd=10, relief=GROOVE, text="Customer Details",
                        font=("times new roman", 15, "bold"), fg="black", bg="light grey")
        F0.place(x=0, y=70, width=950)

        cname_label = Label(F0, text="Customer Name", bg="light grey", font=("times new romen", 18, "bold")).grid(row=0,
                                                                                                                  column=0,
                                                                                                                  padx=20,
                                                                                                                  pady=5)
        ...
        cphn_label = Label(F0, text="Phone No.", bg="light grey", font=("times new romen", 18, "bold")).grid(row=0,
                                                                                                             column=2,
                                                                                                             padx=10,
                                                                                                             pady=5)
        cphn_txt = Entry(F0, width=13, textvariable=self.c_phon, font="arial 15", bd=7, relief=SUNKEN).grid(row=0,
                                                                                                            ...
                                                                                                            pady=5,
                                                                                                            padx=10)
        send_btn2 = Button(F0, command=self.check_phn, text="Send", bg="#FEC260", bd=5, fg="black", width=8,
        ...
        cmail_label = Label(F1, text="Email", bg="light grey", font=("times new romen", 18, "bold")).grid(row=0,
                                                                                                          column=4,
                                                                                                          padx=20,
                                                                                                          pady=5)
        ...
        send_btn = Button(F1, command=self.check_mail, text="Send", bg="#FEC260", bd=5, fg="black", width=8,
                          font="arial 12 bold").grid(row=0, column=7)
        ...
        bath_label = Label(F2, text="Bath Soap", font=("times new roman", 16, "bold"), fg="black",
                           bg="light grey").grid(row=0, column=0, padx=10, pady=10, sticky="w")
        # face cream
        facecream_label = Label(F2, text="Face Cream", font=("times new roman", 16, "bold"), fg="black",
                                bg="light grey").grid(row=1, column=0, padx=10, pady=10, sticky="w")
        ...
        facewash_label = Label(F2, text="Facewash", font=("times new roman", 16, "bold"), fg="black",
                               bg="light grey").grid(row=2, column=0, padx=10, pady=10, sticky="w")
        ...
        hair_Spry_label = Label(F2, text="Hair Spray", font=("times new roman", 16, "bold"), fg="black",
                                bg="light grey").grid(row=3, column=0, padx=10, pady=10, sticky="w")
        ...
        hair_gel_label = Label(F2, text="Hair Gel", font=("times new roman", 16, "bold"), fg="black",
                               bg="light grey").grid(row=4, column=0, padx=10, pady=10, sticky="w")
        ...
        body_lt_label = Label(F2, text="Body Lotion", font=("times new roman", 16, "bold"), fg="black",
                              bg="light grey").grid(row=5, column=0, padx=10, pady=10, sticky="w")
        ...
        g1_label = Label(F3, text="Maggi", font=("times new roman", 16, "bold"), fg="black", bg="light grey").grid(
            row=0, column=0, padx=10, pady=10, sticky="w")
        g1_txt = Entry(F3, width=4, textvariable=self.maggie, font=("times new roman", 16, "bold"), bd=5,
                       relief=SUNKEN).grid(row=0, column=1, padx=10, pady=10, sticky=W)

        g2_label = Label(F3, text="Rice", font=("times new roman", 16, "bold"), fg="black", bg="light grey").grid(row=1,
                                                                                                                  column=0,
                                                                                                                  padx=10,
                                                                                                                  pady=10,
                                                                                                                  sticky="w")
        ...
        g3_label = Label(F3, text="Wheat", font=("times new roman", 16, "bold"), fg="black", bg="light grey").grid(
            row=2, column=0, padx=10, pady=10, sticky="w")
        g3_txt = Entry(F3, width=4, textvariable=self.wheat, font=("times new roman", 16, "bold"), bd=5,
                       relief=SUNKEN).grid(row=2, column=1, padx=10, pady=10, sticky=W)

        g4_label = Label(F3, text="Food oil", font=("times new roman", 16, "bold"), fg="black", bg="light grey").grid(
            row=3, column=0, padx=10, pady=10, sticky="w")
        g4_txt = Entry(F3, width=4, textvariable=self.food_oil, font=("times new roman", 16, "bold"), bd=5,
                       relief=SUNKEN).grid(row=3, column=1, padx=10, pady=10, sticky=W)

        g5_label = Label(F3, text="Daal", font=("times new roman", 16, "bold"), fg="black", bg="light grey").grid(row=4,
                                                                                                                  column=0,
                                                                                                                  padx=10,
                                                                                                                  pady=10,
                                                                                                                  sticky="w")
        ...
        g6_label = Label(F3, text="Sugar", font=("times new roman", 16, "bold"), fg="black", bg="light grey").grid(
        ...
        c1_label = Label(F4, text="Maza", font=("times new roman", 16, "bold"), fg="black", bg="light grey").grid(row=0,
                                                                                                                  column=0,
                                                                                                                  padx=10,
                                                                                                                  pady=10,
                                                                                                                  sticky="w")
        ...
        c2_label = Label(F4, text="Coca cola", font=("times new roman", 16, "bold"), fg="black", bg="light grey").grid(
            row=1, column=0, padx=10, pady=10, sticky="w")
        c2_txt = Entry(F4, width=4, textvariable=self.coca_cola, font=("times new roman", 16, "bold"), bd=5,
                       relief=SUNKEN).grid(row=1, column=1, padx=10, pady=10, sticky=W)

        c3_label = Label(F4, text="Thumbs-up", font=("times new roman", 16, "bold"), fg="black", bg="light grey").grid(
            row=2, column=0, padx=10, pady=10, sticky="w")
        c3_txt = Entry(F4, width=4, textvariable=self.thumbs_up, font=("times new roman", 16, "bold"), bd=5,
                       relief=SUNKEN).grid(row=2, column=1, padx=10, pady=10, sticky=W)

        c4_label = Label(F4, text="Slice", font=("times new roman", 16, "bold"), fg="black", bg="light grey").grid(
            row=3, column=0, padx=10, pady=10, sticky="w")
        c4_txt = Entry(F4, width=4, textvariable=self.slice, font=("times new roman", 16, "bold"), bd=5,
                       relief=SUNKEN).grid(row=3, column=1, padx=10, pady=10, sticky=W)

        c5_label = Label(F4, text="Frooti", font=("times new roman", 16, "bold"), fg="black", bg="light grey").grid(
            row=4, column=0, padx=10, pady=10, sticky="w")
        c5_txt = Entry(F4, width=4, textvariable=self.frooti, font=("times new roman", 16, "bold"), bd=5,
                       relief=SUNKEN).grid(row=4, column=1, padx=10, pady=10, sticky=W)

        c6_label = Label(F4, text="Pepsi", font=("times new roman", 16, "bold"), fg="black", bg="light grey").grid(
            row=5, column=0, padx=10, pady=10, sticky="w")
        ...
        c1_label = Label(F4, text="Parle-G", font=("times new roman", 16, "bold"), fg="black", bg="light grey").grid(
            row=0, column=0, padx=10, pady=10, sticky="w")
        c1_txt = Entry(F4, width=4, textvariable=self.parle, font=("times new roman", 16, "bold"), bd=5,
                       relief=SUNKEN).grid(row=0, column=1, padx=10, pady=10, sticky=W)

        c2_label = Label(F4, text="Britania", font=("times new roman", 16, "bold"), fg="black", bg="light grey").grid(
            row=1, column=0, padx=10, pady=10, sticky="w")
        c2_txt = Entry(F4, width=4, textvariable=self.britania, font=("times new roman", 16, "bold"), bd=5,
                       relief=SUNKEN).grid(row=1, column=1, padx=10, pady=10, sticky=W)

        c3_label = Label(F4, text="Oreo", font=("times new roman", 16, "bold"), fg="black", bg="light grey").grid(row=2,
                                                                                                                  column=0,
                                                                                                                  padx=10,
                                                                                                                  pady=10,
                                                                                                                  sticky="w")
        ...
        c4_label = Label(F4, text="Good Day", font=("times new roman", 16, "bold"), fg="black", bg="light grey").grid(
            row=3, column=0, padx=10, pady=10, sticky="w")
        c4_txt = Entry(F4, width=4, textvariable=self.goodday, font=("times new roman", 16, "bold"), bd=5,
                       relief=SUNKEN).grid(row=3, column=1, padx=10, pady=10, sticky=W)

        c5_label = Label(F4, text="Sunfist", font=("times new roman", 16, "bold"), fg="black", bg="light grey").grid(
            row=4, column=0, padx=10, pady=10, sticky="w")
        c5_txt = Entry(F4, width=4, textvariable=self.sunfist, font=("times new roman", 16, "bold"), bd=5,
                       relief=SUNKEN).grid(row=4, column=1, padx=10, pady=10, sticky=W)

        c6_label = Label(F4, text="Monaco", font=("times new roman", 16, "bold"), fg="black", bg="light grey").grid(
            row=5, column=0, padx=10, pady=10, sticky="w")
        ...
        m1 = Label(F7, text="Total Cosmetic Price", bg="light grey", fg="black",
        ...
        m2 = Label(F7, text="Total Grocery Price", bg="light grey", fg="black",
        ...
        m3 = Label(F7, text="Total Cold-drink Price", bg="light grey", fg="black",
        ...
        m4 = Label(F7, text="Total Biscuit Price", bg="light grey", fg="black",
        ...
        tax1 = Label(F7, text="Cosmetic Tax (28%)", bg="light grey", fg="black",
        ...
        tax2 = Label(F7, text="Grocery Tax (5%)", bg="light grey", fg="black",
        ...
        tax3 = Label(F7, text="Cold-drink Tax (40%)", bg="light grey", fg="black",
        ...
        tax4 = Label(F7, text="Biscuit Tax (5%)", bg="light grey", fg="black",
                     font=("times new roman", 14, "bold")).grid(row=3, column=2, padx=20, pady=1, sticky=W)
        ...
        total_btn = Button(btn_frame, command=self.total, text="Total", bg="#FEC260", bd=5, fg="black", pady=15, width=14,
                           font="arial 12 bold").grid(row=0, column=0, padx=15, pady=15)

        genbill_btn = Button(btn_frame, text="Generate Bill", command=self.bill_area, bg="#FEC260", bd=5, fg="black",
                             pady=15, width=14, font="arial 12 bold").grid(row=0, column=1, padx=15, pady=15)

        clear_btn = Button(btn_frame, text="Clear", command=self.clear_data, bg="#FEC260", bd=5, fg="black", pady=15,
                           width=11, font="arial 12 bold").grid(row=0, column=2, padx=15, pady=15)

        exit_btn = Button(btn_frame, text="Exit", command=self.exit_app, bg="#FEC260", bd=5, fg="black", pady=15, width=11,
        ...
        search_btn = Button(F8, text="Search", command=self.find_bill, bg="#FEC260", bd=5, fg="black", width=8,
        ...
        Label(F9, text="Login :  | ", font=("times new roman", 15, "bold"), fg="black", bg="light grey").grid(row=0,
                                                                                                              column=0)
        Label(F9, text="ID ", font=("times new roman", 15, "bold"), fg="black", bg="light grey").grid(row=0, column=1)

        admin_id1 = Entry(F9, width=25, textvariable=self.admin_id, font="arial 10 bold", bd=7, relief=SUNKEN).grid(
            row=0, column=2, sticky=E)

        Label(F9, text="  Password", font=("times new roman", 15, "bold"), fg="black", bg="light grey").grid(row=0,
                                                                                                             column=3)
        ...
        a_login = Button(F9, text="Login", command=self.login_page, bg="#FEC260", bd=5, fg="black", width=12,
                         font="arial 12 bold").grid(row=0, column=5, padx=35)

        # -------sign up----------------
        Label(F9, text="  Create New Account", font=("times new roman", 15, "bold"), fg="black", bg="light grey").grid(
            row=0, column=6)
        a_sign_up = Button(F9, text="Sign Up", bg="#FEC260", bd=5, fg="black", width=12, font="arial 12 bold").grid(row=0,
                                                                                                                 column=7,
                                                                                                                 padx=35)
    ...
    def image_section(self):
        ...
        F5 = LabelFrame(self.master, bd=10, relief=GROOVE, bg="light grey")
    ...
    def welcome_bill(self):
        ...
        self.txtarea.insert(END, "\t\t|| SUPERMARKET ||")
    ...
    def send_email_bill(self):
        ...
        try:
            ...
            server.ehlo()
            server.starttls()
            server.login("techzoneul@gmail.com", "pycharm123")
            server.sendmail("techzoneul@gmail.com", store_get_3, store_get_4)
    ...
    def check_phn(self):
        messagebox.showinfo("ERROR", f"Bill No. :{self.bill_no.get()} NOT SENT")


    def login_page(self):
        ad_id = self.admin_id.get()
        ad_pass = self.admin_pass.get()
        if (ad_id == "supermarket123"):
...
class login_page_window:
    def __init__(self, master1):
        ...
        title = Label(self.master1, text="SUPERMARKET MANAGEMENT", bd=12, relief=GROOVE, bg="light grey",
                      font=("times new roman", 30, "bold"), pady=2).pack(fill=X)

        # self.image_section2()

        F0 = LabelFrame(self.master1, bd=10, relief=GROOVE, bg="light grey")
        ...
        today_sell = Button(F1, text="Today's Sell", bg="#FEC260", bd=5, fg="black", width=15, font="arial 12 bold").grid(
            row=0, column=0, padx=10, pady=15)

        total_sell = Button(F1, text="Total Sell", bg="#FEC260", bd=5, fg="black", width=15, font="arial 12 bold").grid(
            row=1, column=0, padx=10, pady=15)

        stock = Button(F1, text="Stock", command=self.check_stock, bg="#FEC260", bd=5, fg="black", width=15,
                       font="arial 12 bold").grid(row=2, column=0, padx=10, pady=15)

        update_stock = Button(F1, text="Update Stock", command=self.Update_stock, bg="#FEC260", bd=5, fg="black", width=15,
                              font="arial 12 bold").grid(row=3, column=0, padx=10, pady=15)

        change_password = Button(F1, text="Change password", bg="#FEC260", bd=5, fg="black", width=15,
                                 font="arial 12 bold").grid(row=4, column=0, padx=10, pady=15)

        lis_of_bill = Button(F1, text="Bill List", command=self.bill_list, bg="#FEC260", bd=5, fg="black", width=15,
                             font="arial 12 bold").grid(row=5, column=0, padx=10, pady=15)

        clear = Button(F1, text="Clear", command=self.clear_admin_notebook, bg="#FEC260", bd=5, fg="black", width=15,
                       font="arial 12 bold").grid(row=6, column=0, padx=10, pady=15)

        F3 = LabelFrame(self.master1, bd=10, text="Bottom", relief=GROOVE, bg="light grey")
        ...
        F2 = LabelFrame(self.master1, bd=10, relief=GROOVE, bg="light grey")
